...
# ─────────────────────────── 資料庫 ───────────────────────────
DB_HOST     = os.getenv("DB_HOST", "127.0.0.1")   # 資料庫主機位址
DB_PORT     = _env_int("DB_PORT", 3306)           # 連線埠（MySQL 8.0 預設 3306 / 本機 MariaDB 為 3307）
DB_USER     = os.getenv("DB_USER", "root")        # 登入帳號
DB_PASSWORD = os.getenv("DB_PASSWORD", "")        # 登入密碼
DB_DATABASE = os.getenv("DB_DATABASE", "shoppingapp")  # 資料庫名稱
...
SESSION_KEY   = os.getenv("SESSION_KEY", "MyShoppingAppProject")  # 建立 SESSION 時使用的 KEY
...
ECPAY_AIO_URL = os.getenv("ECPAY_AIO_URL", "https://payment-stage.ecpay.com.tw/Cashier/AioCheckOut/V5")
